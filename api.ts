...
export const OpenAIApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async cancelFineTune(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<FineTune>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.cancelFineTune(
        fineTuneId,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createAnswer(
        createAnswerRequest,
        options
      );
      return createRequestFunction(
    ...
    async createFile(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<OpenAIFile>
    > {
    ...
    async createFineTune(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<FineTune>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createFineTune(
        createFineTuneRequest,
        options
      );
      return createRequestFunction(
    ...
    async createImage(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ImagesResponse>
    > {
    ...
    async createImageEdit(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ImagesResponse>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createImageEdit(
        image,
        mask,
        prompt,
        n,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createImageVariation(
          image,
          n,
          size,
          responseFormat,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.createSearch(
        engineId,
        createSearchRequest,
        options
      );
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listEngines(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listFineTunes(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.listModels(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
    ...
    async retrieveEngine(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Engine>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.retrieveEngine(
        engineId,
        options
      );
      return createRequestFunction(
    ...
    async retrieveFile(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<OpenAIFile>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.retrieveFile(
        fileId,
        options
      );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.retrieveFineTune(fineTuneId, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async retrieveModel(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Model>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.retrieveModel(
        model,
        options
      );
      return createRequestFunction(
